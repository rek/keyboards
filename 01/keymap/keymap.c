    ...
    const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [_RAISE] = LAYOUT(
            ...
            _______   , _______  , KC_LT     , KC_GT     , KC_LBRC   , KC_RBRC   ,             _______      , C(A(KC_Y))  , _______ , _______ , C(A(KC_U)) , _______,
            _______   , _______  , KC_LPRN   , KC_RPRN   , KC_F2     , _______   ,             _______      , KC_HOME     , KC_PGUP , KC_PGDN , KC_END  , _______,
            _______   , _______  , KC_LCBR   , KC_RCBR   , C(A(KC_F)), A(KC_D)   ,             KC_TAB       , _______     , _______ , _______ , _______ , _______,
